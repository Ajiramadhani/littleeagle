							...
							<div class="single-cat-widget">
								<div class="content relative">
								    ...
								    <a href="#" target="_blank">
								      <div class="thumb">
								  		 <img class="content-image img-fluid d-block mx-auto" src="<?php echo base_url(); ?>assets_frontend/depan/img/blog/cat-widget1.jpg" alt="">
								  	  </div>
						...
						<div class="col-lg-4">
							<div class="single-cat-widget">
								<div class="content relative">
								    ...
								    <a href="#" target="_blank">
								      <div class="thumb">
								  		 <img class="content-image img-fluid d-block mx-auto" src="<?php echo base_url(); ?>assets_frontend/depan/img/blog/cat-widget2.jpg" alt="">
								  	  </div>
								      <div class="content-details">
						...
						<div class="col-lg-4">
							<div class="single-cat-widget">
								<div class="content relative">
								    ...
								    <a href="#" target="_blank">
								      <div class="thumb">
								  		 <img class="content-image img-fluid d-block mx-auto" src="<?php echo base_url(); ?>assets_frontend/depan/img/blog/cat-widget3.jpg" alt="">
								  	  </div>
								      <div class="content-details">
