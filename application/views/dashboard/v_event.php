								...
								<tbody>
									...
									foreach($event as $a){ 
										...
										<tr>
											...
											<!-- <td>Rp. <?= number_format($a->event_harga, 0, '.', '.')?></td> -->
											<td>
												<a target="_blank" href="<?php echo base_url('det_guru/').$a->event_slug; ?>" class="btn btn-success btn-sm"> <i class="fa fa-eye"></i> </a>
												<?php 
