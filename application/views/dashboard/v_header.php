				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li>
						<a href="<?php echo base_url().'dashboard/kata' ?>">
							...
							<span>UPLOAD VIDEO TESTI</span>
						</a>
					</li>
					<li class="treeview">
						<a href="#"><span>INPUT MENU</span><i class="fa fa-angle-left pull-right"></i></a>
					...
					<li class="treeview">
							<a href="#"><span>BACKGORUND MENU</span><i class="fa fa-angle-left pull-right"></i></a>
							<ul class="treeview-menu">
							<li>
								<a href="<?php echo base_url().'dashboard/pengaturan' ?>">
									<i class="fa fa-edit"></i>
									<span>GANTI BACKGROUND HOME</span>
								</a>
							</li>
							<li>
								<a href="<?php echo base_url().'dashboard/pengaturan' ?>">
									<i class="fa fa-edit"></i>
									<span>GANTI BACKGROUND ABOUT</span>
								</a>
							</li>
							<li>
								<a href="<?php echo base_url().'dashboard/pengaturan' ?>">
									<i class="fa fa-edit"></i>
									<span>GANTI BACKGROUND BLOG</span>
								</a>
							</li>
							<li>
								<a href="<?php echo base_url().'dashboard/pengaturan' ?>">
									<i class="fa fa-edit"></i>
									<span>GANTI BACKGROUND GURU</span>
								</a>
							</li>
							</ul>
						</li>
